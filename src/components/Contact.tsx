  ...
  return (
    <section id="contact" className="bg-white py-20">
      <div className="container">
        <h2 className="text-3xl sm:text-4xl md:text-5xl font-extrabold font-serif text-center text-foreground">Get In Touch</h2>
        ...
        <div className="mt-10 max-w-lg mx-auto">
          <motion.form
            ...
            className="bg-background rounded-2xl p-7 shadow-card space-y-4"
          >
        ...
        <div className="mt-16 text-center">
          ...
          <div className="flex justify-center flex-wrap gap-6">
            {socialLinks.map(link => (
              <a key={link.name} href={link.href} target="_blank" rel="noopener noreferrer" className="text-muted-foreground hover:text-primary transition-colors text-xl">
                {link.icon}
              </a>
            ))}
          </div>
