...
import { SiC, SiTailwindcss, SiExpress, SiMongodb, SiMysql, SiPostman, SiVscode } from 'react-icons/si';
...
const skillsList = [
    ...
    { name: 'VS Code', icon: <SiVscode className="h-10 w-10 transition-colors" />, color: "group-hover:text-[#007ACC]" },
];
